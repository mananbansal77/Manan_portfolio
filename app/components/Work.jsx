...
const Work = ({ isDarkMode }) => {
  return (
    ...
    >
      ...
      >
        Currently, I am working on full-stack projects, including a finance manager and a resume builder. I have already developed a currency converter in Java, a brain tumor detection system using deep learning, a mini Java compiler, and a deadlock handling project in databases.
      </motion.p>
      <motion.div
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
